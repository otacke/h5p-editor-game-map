...
export default class ToolbarButton {
  ...
  constructor(params, callbacks) {
    ...
    // Tooltip
    if (this.params.tooltip || this.params.keyshortcuts) {
      const tooltip = document.createElement('span');
      tooltip.classList.add('tooltip');
      if (this.params.tooltip && this.params.keyshortcuts) {
        tooltip.textContent = `${this.params.tooltip} (${this.params.keyshortcuts})`;
      }
      else if (this.params.tooltip) {
        tooltip.textContent = this.params.tooltip;
      }
      else if (this.params.keyshortcuts) {
        tooltip.textContent = this.params.keyshortcuts;
      }

      this.dom.append(tooltip);
    }
  }
